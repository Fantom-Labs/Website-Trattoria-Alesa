  ...
  return (
    <section className="relative mt-10 sm:mt-12 lg:mt-16" data-header-theme="brown">
      <div className="grid min-h-0 grid-cols-1 lg:grid-cols-2 lg:min-h-[min(90dvh,52rem)]">
        ...
        <div className="relative order-1 min-h-[min(52vw,22rem)] w-full overflow-visible sm:min-h-[min(48vw,26rem)] lg:order-2 lg:min-h-0">
          <Image
          ...
          />
          <div
            className="pointer-events-none absolute bottom-0 left-1/2 z-10 flex -translate-x-1/2 translate-y-1/2 justify-center lg:hidden"
            aria-hidden
          >
            <AboutStamp />
          </div>
